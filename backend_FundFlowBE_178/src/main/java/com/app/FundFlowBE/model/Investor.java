...
@Table(name = "\"Investor\"", schema =  "\"fundflowbe_352\"")
@Data
...
@Column(name = "\"InvestmentPreferences\"")
    ...
    @CollectionTable(schema = "\"fundflowbe_352\"", name = "\"InvestorInvestmentPreferences\"",joinColumns = @JoinColumn(name = "\"InvestorId\""))
