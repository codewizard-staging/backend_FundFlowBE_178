...
class ControllerTest {
  ...
  @AfterEach
  void  teardown() {
    jdbcTemplate.execute("DELETE FROM fundflowbe_352.FundingRound");
    jdbcTemplate.execute("DELETE FROM fundflowbe_352.Stage");
    jdbcTemplate.execute("DELETE FROM fundflowbe_352.Document");
    jdbcTemplate.execute("DELETE FROM fundflowbe_352.Investor");
    jdbcTemplate.execute("DELETE FROM fundflowbe_352.Founder");
    jdbcTemplate.execute("DELETE FROM fundflowbe_352.Startup");
     jdbcTemplate.execute("DELETE FROM fundflowbe_352.StartupFounders");
     jdbcTemplate.execute("DELETE FROM fundflowbe_352.StartupKeyMetrics");
     jdbcTemplate.execute("DELETE FROM fundflowbe_352.InvestorInvestmentPreferences");
     jdbcTemplate.execute("DELETE FROM fundflowbe_352.StartupPreviousRounds");
     jdbcTemplate.execute("DELETE FROM fundflowbe_352.FundingRoundInvestors");
